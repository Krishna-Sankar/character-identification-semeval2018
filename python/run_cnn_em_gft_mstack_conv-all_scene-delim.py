...
from models.cnn_em_gft import EntityMentionGroupFeatCNN_MStackConvAll
...
def main():
    ...
    if not evalOnly:
        ...
        model = EntityMentionGroupFeatCNN_MStackConvAll(nb_m4entity, nb_embs, embdim, embftdim, dftdim, nb_filters, gpu_id=gpu_id)
