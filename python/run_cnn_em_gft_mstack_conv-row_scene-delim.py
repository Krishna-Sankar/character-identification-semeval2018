...
from models.cnn_em_gft import EntityMentionGroupFeatCNN_MStackConvRows
...
def main():
    ...
    if not evalOnly:
        ...
        model = EntityMentionGroupFeatCNN_MStackConvRows(nb_m4entity, nb_embs, embdim, embftdim, dftdim, nb_filters, gpu_id=gpu_id)
